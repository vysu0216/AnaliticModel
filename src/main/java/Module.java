...
public class Module {
    ...
    private static final double L01 = 0.01; //интенсивность потока в систему S1 (микропроцессор)
    private static final double L02 = 10.0; //интенсивность потока в в систему S2 (приемо-передатчик)
    ...
    public static void main(String[] args) {
        new Module().calcS1Characteristics();
    }
